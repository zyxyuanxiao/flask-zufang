...
class House(BaseModel, db.Model):
    ...
    def to_basic_dict(self):
        ...
        house_dict = {
            ...
            "img_url": const.QINIU_URL_DOMAIN + self.index_image_url if self.index_image_url else "",
            "room_count": self.room_count,
            "order_count": self.order_count,
            "address": self.address,
            "user_avatar": const.QINIU_URL_DOMAIN + self.user.avatar_url if self.user.avatar_url else "",
...
class Order(BaseModel, db.Model):
    ...
    def to_dict(self):
        ...
        order_dict = {
            ...
            "img_url": const.QINIU_URL_DOMAIN + self.house.index_image_url if self.house.index_image_url else "",
